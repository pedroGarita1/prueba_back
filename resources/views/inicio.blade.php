                    ...
                    <table class="table table-hover text-center align-middle table-sm table-responsive-sm display responsive nowrap" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="" class="btn btn-outline-secondary"></a></td>
                                <td><a href="{{ route('Vistas-usuario', ['id'=>$item->id]) }}" class="btn btn-outline-primary"></a></td>
                                <td><a href="" class="btn btn-outline-danger"></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
